...
brew cask outdated
brew cask outdated --greedy # also lists cask that update themselves
...
```sh
# list all apps installed via the app store
mas list
...
mas install 905747757 # Silent Start
 ```
